...
- [Einführung in die Spieltheorie](SpieltheorieEinfuehrung.md#einfuhrung-in-die-spieltheorie)
  - [Definitionen](SpieltheorieEinfuehrung.md#definitionen)
    - [Strategische Normalform](SpieltheorieEinfuehrung.md#strategische-normalform)
    - [Extensivform](SpieltheorieEinfuehrung.md#extensivform)
  - [Nash-Gleichgewicht bei vollständiger Information](SpieltheorieEinfuehrung.md#nash-gleichgewicht-bei-vollstandiger-information)
    - [Nash-Gleichgewicht in reinen Strategien mit kleiner Strategiemenge](SpieltheorieEinfuehrung.md#nash-gleichgewicht-in-reinen-strategien-mit-kleiner-strategiemenge)
      - [Beispiel 1: Konkurrierende Unternehmen](SpieltheorieEinfuehrung.md#beispiel-1-konkurrierende-unternehmen)
    - [Nash-Gleichgewicht in reinen Strategien mit großer oder unbegrenzter Strategiemenge](SpieltheorieEinfuehrung.md#nash-gleichgewicht-in-reinen-strategien-mit-groser-oder-unbegrenzter-strategiemenge)
      - [Beispiel 2: Konkurrierende Unternehmen](SpieltheorieEinfuehrung.md#beispiel-2-konkurrierende-unternehmen)
      - [Beispiel 3: Konkurrierende Tankstellen](SpieltheorieEinfuehrung.md#beispiel-3-konkurrierende-tankstellen)
    - [Nash-Gleichgewicht in gemischten Strategien](SpieltheorieEinfuehrung.md#nash-gleichgewicht-in-gemischten-strategien)
      - [Satz von Nash](SpieltheorieEinfuehrung.md#satz-von-nash)
      - [Beispiel 4: Sherlock Holmes und Professor Moriarty](SpieltheorieEinfuehrung.md#beispiel-4-sherlock-holmes-und-professor-moriarty)
      - [Beispiel 5: Diebstahlkontrolle](SpieltheorieEinfuehrung.md#beispiel-5-diebstahlkontrolle)
    - [Rückwärtsinduktion](SpieltheorieEinfuehrung.md#ruckwartsinduktion)
    - [Sequentielle Spiele](SpieltheorieEinfuehrung.md#sequentielle-spiele)
      - [Beispiel 6: Markteintritt](SpieltheorieEinfuehrung.md#beispiel-6-markteintritt)
      - [Chainstore-Paradoxon](SpieltheorieEinfuehrung.md#chainstore-paradoxon)
  - [Bayes-Gleichgewicht bei unvollständiger Information](SpieltheorieEinfuehrung.md#bayes-gleichgewicht-bei-unvollstandiger-information)
    - [Beispiel 7: Sheriff's dilemma](SpieltheorieEinfuehrung.md#beispiel-7-sheriffs-dilemma)
    - [Beispiel 8: Markteintritt](SpieltheorieEinfuehrung.md#beispiel-8-markteintritt)
    - [Perfect Bayesian Equilibrium (PBE)](SpieltheorieEinfuehrung.md#perfect-bayesian-equilibrium-pbe)
    - [Beispiel 9: Bier-Quiche-Spiel](SpieltheorieEinfuehrung.md#beispiel-9-bier-quiche-spiel)
  - [Hilbert-Tankstellen](SpieltheorieEinfuehrung.md#hilbert-tankstellen)
  - [Folk-Theorem und unendlich oft wiederholte Spiele](SpieltheorieEinfuehrung.md#folk-theorem-und-unendlich-oft-wiederholte-spiele)
  - [Paradoxa](SpieltheorieEinfuehrung.md#paradoxa)
  - [Literatur, Links](SpieltheorieEinfuehrung.md#literatur-links)
...
In einer Spielmatrix können dominierte Strategien wie folgt gefunden und entfernt werden: 
* Spieler 1, Zeilenspieler: Vergleiche die Werte $U_1$ in zwei Zeilen $i$ und $k$. Sind in allen Spalten $j$ die Werte $U_1(i,j)$ in Zeile $i$ kleiner oder gleich den Werten $U_1(k,j)$ in Zeile $k≠i$, dann Zeile $i$ löschen.
* Spieler 2, Spaltenspieler: Vergleiche die Werte $U_2$ in zwei Spalten $j$ und $k$. Sind in allen Zeilen $i$ die Werte $U_1(i,j)$ in Spalte $j$ kleiner oder gleich den Werten $U_2(i,k)$ in Spalte $k≠i$, dann Spalte $k$ löschen.
* Beispiel: Funktion find_dominant_strategies in [mini_wm_robinson_forrest.py](../src/mini_wm_robinson_forrest.py)
...
### Nash-Gleichgewicht in reinen Strategien mit großer oder unbegrenzter Strategiemenge<a id="nash-gleichgewicht-in-reinen-strategien-mit-groser-oder-unbegrenzter-strategiemenge"></a>
...
Satz von Bayes: $P(A_i|B) \cdot P(B) = P(B|A_i) \cdot P(A_i)  ⇔ P(A_i|B) = P(B|A_i) \cdot P(A_i) / P(B)$  
...
## Folk-Theorem und unendlich oft wiederholte Spiele<a id="folk-theorem-und-unendlich-oft-wiederholte-spiele"></a>
...
<!---
TODO: ## Evolutionäre Spieltheorie
* [Evolutionäre Spieltheorie](https://de.wikipedia.org/wiki/Evolution%C3%A4re_Spieltheorie)
* [Evolutionär stabile Strategien (ESS)](https://de.wikipedia.org/wiki/Evolution%C3%A4r_stabile_Strategie)
* [Evolutorische Spieltheorie](https://www.mathematik.uni-muenchen.de/~spielth/lektionen/lektion07.pdf)
-->
...
## Literatur, Links<a id="literatur-links"></a>

* Erwin Amann: "Spieltheorie für dummies", Wiley, 2. Auflage 2026
* Andreas Diekmann: "Spieltheorie. Einführung, Beispiele, Experimente", 1. Auflage 2009
* Christian Rieck: "Spieltheorie. Eine Einführung", 17. Auflage 2025
...
* [Game Theory Explorer](https://www.gametheoryexplorer.org): Interaktive Spielbäume und deren Lösung
